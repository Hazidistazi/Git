...
#include <memory>
#include "../Album-test/datamanager.h"
...
QT_MOC_LITERAL(1, 12, 15), // "addDirModelData"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 4), // "name"
QT_MOC_LITERAL(4, 34, 3), // "url"
QT_MOC_LITERAL(5, 38, 3), // "num"
QT_MOC_LITERAL(6, 42, 9) // "firstPath"

    },
    "DataManager\0addDirModelData\0\0name\0url\0"
    "num\0firstPath"
};
...
void DataManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->addDirModelData((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< QString(*)>(_a[4]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DataManager::*)(QString , QString , int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataManager::addDirModelData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DataManager::addDirModelData(QString _t1, QString _t2, int _t3, QString _t4)
{
